...
datasets = dict(LCCFASD_root='./LCC_FASDcropped',
                Celeba_root='/home/prixa-ml/Desktop/projects/liveness-detection/Face-Recognition/spoof_or_not/light-weight-face-anti-spoofing/CelebA_Spoof_small',
                Casia_root='./CASIA')
...
epochs = dict(start_epoch=0, max_epoch=10)
...
model= dict(model_type='Mobilenet3',
            ...
            imagenet_weights='/home/prixa-ml/Desktop/projects/liveness-detection/Face-Recognition/spoof_or_not/light-weight-face-anti-spoofing/mobilenetv3.pytorch/pretrained/mobilenetv3-large-1cd25616.pth')
